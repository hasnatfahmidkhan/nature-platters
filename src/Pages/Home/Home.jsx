  ...
  return (
    <div>
      <>
        ...
        {/* Hero Section  */}
        <section className="bg-gradient-to-b from-[#FFFFFF] to-[#EFEBE3] flex flex-col justify-center items-center pt-32 gap-10">
        ...
        <Container>
          <section>
            ...
            <div className="grid grid-cols-2 gap-x-0 md:gap-x-8 py-7">
              <div>
                <NewArriavalCard
